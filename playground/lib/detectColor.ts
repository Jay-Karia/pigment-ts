...
export function detectColor(line: string) {
  ...
  const regex = {
    ...
    hex: /#[0-9A-F]{6}/i,
    hsl: /hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/,
    tw: /(?:$|^|)(slate-|gray-|zinc-|neutral-|stone-|red-|orange-|amber-|yellow-|lime-|green-|emerald-|teal-|cyan-|sky-|blue-|indigo-|violet-|purple-|fuchsia-|pink-|rose-|white|black)(100|200|300|400|500|600|700|800|900|950|50)(?:$|^|)/,
